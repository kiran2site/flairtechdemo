    ...
    return (
        ...
        <Nav className="ml-auto container" navbar>
            ...
            <div className="d-flex ml-auto mr-auto">
              ...
              <Link to="/dashboard/console/createtemplate" className="nav-link shove"><NavItem className="m-2 p-2"><span><Popup content='Template' offset='0, 10px' trigger={<Icon name="edit" size="big"/>}  position='bottom center' /></span> </NavItem></Link>
          ...
          <div className="">
            <UncontrolledDropdown nav Navbar>
              ...
              <DropdownMenu right>
                ...
                <Link to="/dashboard/console" className="nav-link shove"><DropdownItem>Admin Console</DropdownItem></Link>
